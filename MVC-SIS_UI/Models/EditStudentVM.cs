...
namespace MVC_SIS_UI.Models
{
    public class EditStudentVM : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (Student == null)
            {
                errors.Add(new ValidationResult("Please enter the student's information.",
                    new[] { "Student" }));
                return errors;
            }
            ...
            if (string.IsNullOrEmpty(Student.GPA.ToString()))
            {
                errors.Add(new ValidationResult("Please enter the student's GPA.",
                    new[] { "Student.GPA" }));
            }
            if (string.IsNullOrEmpty(Student.Major.MajorId.ToString()))
            {
